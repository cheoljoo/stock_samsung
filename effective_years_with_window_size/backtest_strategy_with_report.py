...
"""
    ...
    # 리포트 파일 저장
    main_path, backup_path = save_report_files(report_content, 'strategy_analysis_report', period_name)
    
    print(f"\n📋 {period_name} 전략 분석 리포트 저장 완료")
...
"""
    ...
    # 종합 리포트 파일 저장
    main_path, backup_path = save_report_files(report_content, 'comprehensive_analysis_report')
...
"""
    ...
    # 종합 요약 리포트 파일 저장
    main_path, backup_path = save_report_files(report_content, 'summary_backtest_report')
